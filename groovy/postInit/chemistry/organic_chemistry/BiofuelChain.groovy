...
TBR.recipeBuilder()
        ...
        .fluidOutputs(fluid('hydrodeoxygenation_reaction_outlet') * 8000)
        .duration(tpbnp)
        .EUt(120)
        .buildAndRegister()
...
PHASE_SEPARATOR.recipeBuilder()
        .fluidInputs(fluid('hydrodeoxygenation_reaction_outlet') * 8000)
...
SIEVE_DT.recipeBuilder()
        ...
        .fluidOutputs(fluid('green_naphtha') * 125)
...
SIEVE_DT.recipeBuilder()
        ...
        .fluidOutputs(fluid('green_diesel') * 800)
        .fluidOutputs(fluid('green_kerosene') * 300)
        .duration(tpbnp * 6)
        .EUt(30)
        .buildAndRegister()

// -------- Converting Final Products to their Petrochem equivalents --------
CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('green_diesel') * 1000)
...
CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('green_kerosene') * 1000)
        .fluidOutputs(fluid('kerosene') * 1000)
        .duration(20)
        .EUt(7)
        .buildAndRegister()

CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('green_naphtha') * 1000)
